...
const $1a4022318fbf89ac$var$Tour = $bdTtH$mongoose.model(
  "Keycaps",
  $1a4022318fbf89ac$var$keycapsSchema,
);
...
const $a7ba91d74de65be3$var$getAllKeycaps = async (req, res) => {
  try {
    //filtering
    const features = new $1663c8bfb6a7d7c6$exports(
      $1a4022318fbf89ac$exports.find(),
      req.query,
    )
      .filter()
      .sort();
...
$a7ba91d74de65be3$var$router
  .route("/")
  .get($a7ba91d74de65be3$var$getAllKeycaps);
...
const $ca542f5d2e70e274$var$Tour = $bdTtH$mongoose.model(
  "Keyswitches",
  $ca542f5d2e70e274$var$keyswitchesSchema,
);
...
$20522c158ca49668$var$router
  .route("/")
  .get($20522c158ca49668$var$getAllKeySwitches);
$20522c158ca49668$var$router
  .route("/:id")
  .get($20522c158ca49668$var$getkeySwitch);
...
const $108e5f2022792aa7$var$Tour = $bdTtH$mongoose.model(
  "FullBuild",
  $108e5f2022792aa7$var$fullBuildSchema,
);
...
$9bcceecfed209758$var$router
  .route("/")
  .get($9bcceecfed209758$var$getAllBuildKits);
$9bcceecfed209758$var$router
  .route("/:id")
  .get($9bcceecfed209758$var$getBuildKit);
...
$bdTtH$dotenv.config();
let $2685e5b20c9f29f6$var$db =
  "mongodb+srv://tonibaglien:<PASSWORD>@keyworks.6iojnvs.mongodb.net/?retryWrites=true&w=majority";
let $2685e5b20c9f29f6$var$dbpw = "o7YRf7sLvKOBZayP";
const $2685e5b20c9f29f6$var$DB = $2685e5b20c9f29f6$var$db.replace(
  "<PASSWORD>",
  $2685e5b20c9f29f6$var$dbpw,
);
